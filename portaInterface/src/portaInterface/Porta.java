package portaInterface;
   ...
   /*Implementa a interface Cloneable, 
    * que permite criar um novo objeto com base no objeto original. 
	*/ 
public class Porta implements Cloneable {
	...
	/* Método get que permite acessar 
	 * o atributo altura de um objeto "porta". 
	 */
	...
	/* Método get que permite acessar 
	 * o atributo Largura de um objeto "porta". 
	 */
	...
	/* Método get que permite acessar 
	 * o atributo aberta de um objeto "porta".
	 */
	public boolean isAberta() {
		return aberta;
	}
	
	/* Método da classe Object que é sobrescrito 
	 * para criar uma cópia de um objeto original (porta).
	 */
